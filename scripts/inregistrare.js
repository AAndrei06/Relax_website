...
togglePasswordButton.addEventListener('click', function ()
{
    if (passwordField.type === 'password')
    {
        ...
        togglePasswordButton.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M9.99984 4.1665C4.6968 4.1665 1.6665 9.99984 1.6665 9.99984C1.6665 9.99984 4.6968 15.8332 9.99984 15.8332C15.3028 15.8332 18.3332 9.99984 18.3332 9.99984C18.3332 9.99984 15.3028 4.1665 9.99984 4.1665Z" stroke="var(--day-dark01)" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /> <path d="M10 12.5C11.3807 12.5 12.5 11.3807 12.5 10C12.5 8.61925 11.3807 7.5 10 7.5C8.61925 7.5 7.5 8.61925 7.5 10C7.5 11.3807 8.61925 12.5 10 12.5Z" stroke="var(--day-dark01)" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /> </svg>'
    } else
    {
